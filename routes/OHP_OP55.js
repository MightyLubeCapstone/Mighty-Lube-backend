...
router.post("/", authenticate, async (req, res) => {
    try {
        ...
        const order = new OHP_OP55({
            ...
            ...(OHP_OP55Data.otherChainSize && { otherChainSize: OHP_OP55Data.otherChainSize }),
            industrialChainManufacturer: OHP_OP55Data.industrialChainManufacturer,
            ...(OHP_OP55Data.otherChainManufacturer && {
                otherChainManufacturer: OHP_OP55Data.otherChainManufacturer
            }),
            ...(OHP_OP55Data.conveyorLength && {
                conveyorLength: OHP_OP55Data.conveyorLength
            }),
            ...(OHP_OP55Data.conveyorLengthUnit && {
                conveyorLengthUnit: OHP_OP55Data.conveyorLengthUnit
            }),
            ...(OHP_OP55Data.appEnviroment && {
                appEnviroment: OHP_OP55Data.appEnviroment
            }),
            ...(OHP_OP55Data.ovenStatus && { ovenStatus: OHP_OP55Data.ovenStatus }),
            ...(OHP_OP55Data.ovenTemp && { ovenTemp: OHP_OP55Data.ovenTemp }),
            ...(OHP_OP55Data.otherAppEnviroment && {
                otherAppEnviroment: OHP_OP55Data.otherAppEnviroment
            }),
            operatingVoltage: OHP_OP55Data.operatingVoltage,
            controlVoltSingle: OHP_OP55Data.controlVoltSingle,
            ...(OHP_OP55Data.lubeBrand && { lubeBrand: OHP_OP55Data.lubeBrand }),
            ...(OHP_OP55Data.lubeType && { lubeType: OHP_OP55Data.lubeType }),
            ...(OHP_OP55Data.lubeViscosity && {
                lubeViscosity: OHP_OP55Data.lubeViscosity
            }),
            ...(OHP_OP55Data.sideLubeStatus && {
                sideLubeStatus: OHP_OP55Data.sideLubeStatus
            }),
            ...(OHP_OP55Data.topLubeStatus && {
                topLubeStatus: OHP_OP55Data.topLubeStatus
            }),
            ...(OHP_OP55Data.chainMaster && {
                chainMaster: OHP_OP55Data.chainMaster
            }),
            ...(OHP_OP55Data.timerStatus && {
                timerStatus: OHP_OP55Data.timerStatus
            }),
            ...(OHP_OP55Data.electricStatus && {
                electricStatus: OHP_OP55Data.electricStatus
            }),
            ...(OHP_OP55Data.plcConnection && {
                plcConnection: OHP_OP55Data.plcConnection
            }),
            ...(OHP_OP55Data.otherControllerNotes && {
                otherControllerNotes: OHP_OP55Data.otherControllerNotes
            }),
            ...(OHP_OP55Data.specialControllerOption && {
                specialControllerOption: OHP_OP55Data.specialControllerOption
            }),
            ...(OHP_OP55Data.specialControllerInfo && {
                specialControllerInfo: OHP_OP55Data.specialControllerInfo
            }),

            // ✅ NEW FIELD ADDED
            // Technician-specific notes / remarks
            ...(OHP_OP55Data.technicianNote && {
                technicianNote: OHP_OP55Data.technicianNote
            }),
        });
