    ...
    try {
        ...
        const order = new OHP_PMM({
            ...
            monitorData: new templateA({
                ...
                ...(OHP_PMMData.templateA.itNameOne && { itNameOne: OHP_PMMData.templateA.itNameOne }),
                ...(OHP_PMMData.templateA.itIPOne && { itIPOne: OHP_PMMData.templateA.itIPOne }),
                ...(OHP_PMMData.templateA.itGatewayOne && { itGatewayOne: OHP_PMMData.templateA.itGatewayOne }),
                ...(OHP_PMMData.templateA.itSubnetOne && { itSubnetOne: OHP_PMMData.templateA.itSubnetOne }),
                ...(OHP_PMMData.templateA.itDNSOne && { itDNSOne: OHP_PMMData.templateA.itDNSOne }),
                ...(OHP_PMMData.templateA.itSMTPOne && { itSMTPOne: OHP_PMMData.templateA.itSMTPOne }),
                ...(OHP_PMMData.templateA.itNameTwo && { itNameTwo: OHP_PMMData.templateA.itNameTwo }),
                ...(OHP_PMMData.templateA.itIPTwo && { itIPTwo: OHP_PMMData.templateA.itIPTwo }),
                ...(OHP_PMMData.templateA.itGatewayTwo && { itGatewayTwo: OHP_PMMData.templateA.itGatewayTwo }),
                ...(OHP_PMMData.templateA.itSubnetTwo && { itSubnetTwo: OHP_PMMData.templateA.itSubnetTwo }),
                ...(OHP_PMMData.templateA.itDNSTwo && { itDNSTwo: OHP_PMMData.templateA.itDNSTwo }),
                ...(OHP_PMMData.templateA.itSMTPTwo && { itSMTPTwo: OHP_PMMData.templateA.itSMTPTwo }),
                ...(OHP_PMMData.templateA.itNameThree && { itNameThree: OHP_PMMData.templateA.itNameThree }),
                ...(OHP_PMMData.templateA.itIPThree && { itIPThree: OHP_PMMData.templateA.itIPThree }),
                ...(OHP_PMMData.templateA.itGatewayThree && { itGatewayThree: OHP_PMMData.templateA.itGatewayThree }),
                ...(OHP_PMMData.templateA.itSubnetThree && { itSubnetThree: OHP_PMMData.templateA.itSubnetThree }),
                ...(OHP_PMMData.templateA.itDNSThree && { itDNSThree: OHP_PMMData.templateA.itDNSThree }),
                ...(OHP_PMMData.templateA.itSMTPThree && { itSMTPThree: OHP_PMMData.templateA.itSMTPThree }),
                ...(OHP_PMMData.templateA.itAdditionalNotes && { itAdditionalNotes: OHP_PMMData.templateA.itAdditionalNotes }),
