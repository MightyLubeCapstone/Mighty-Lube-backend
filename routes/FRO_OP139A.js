...
/**
 * This API is used to create and store a FRO_OP139A form configuration.
 *
 * - Accepts FRO_OP139AData from the request body
 * - Dynamically maps only available fields to avoid storing empty values
 * - Creates a new FRO_OP139A configuration object
 ...
 * It does not affect pricing, calculations, or form processing.
 */
router.post("/", authenticate, async (req, res) => {
    // used for FRO_OP139A form
    try {
        ...
        const order = new FRO_OP139A({
            ...
            ...(FRO_OP139AData.technicianNote && { technicianNote: FRO_OP139AData.technicianNote }),
