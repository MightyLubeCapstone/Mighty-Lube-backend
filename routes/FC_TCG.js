...
router.post("/", authenticate, async (req, res) => {
    try {
        ...
        const order = new FC_TCG({
            conveyorName: FC_TCGData.conveyorName,
            industrialChainManufacturer: FC_TCGData.industrialChainManufacturer,
            ...(FC_TCGData.otherIndustrialChainManufacturer && {
                otherIndustrialChainManufacturer: FC_TCGData.otherIndustrialChainManufacturer
            }),
            wheelManufacturer: FC_TCGData.wheelManufacturer,
            ...(FC_TCGData.otherWheelManufacturer && {
                otherWheelManufacturer: FC_TCGData.otherWheelManufacturer
            }),
            conveyorSpeed: FC_TCGData.conveyorSpeed,
            conveyorSpeedUnit: FC_TCGData.conveyorSpeedUnit,
            conveyorIndex: FC_TCGData.conveyorIndex,
            appEnviroment: FC_TCGData.appEnviroment,
            ...(FC_TCGData.otherAppEnviroment && {
                otherAppEnviroment: FC_TCGData.otherAppEnviroment
            }),
            surroundingTemp: FC_TCGData.surroundingTemp,
            orientationType: FC_TCGData.orientationType,
            operatingVoltage: FC_TCGData.operatingVoltage,
            ...
            // 🔹 NEW FIELD ADDED
            // Technician specific note / observation
            // Optional field – will be saved only if provided from UI / payload
            ...(FC_TCGData.technicianNote && { technicianNote: FC_TCGData.technicianNote })
        });
