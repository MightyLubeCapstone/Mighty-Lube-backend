...
router.post("/", authenticate, async (req, res) => {
    ...
    try {
        ...
        const order = new IFT_OP4OE({
            ...
            //     ...(IFT_OP4OEData.templateA.itNameOne && { itNameOne: IFT_OP4OEData.templateA.itNameOne }),
            //     ...(IFT_OP4OEData.templateA.itIPOne && { itIPOne: IFT_OP4OEData.templateA.itIPOne }),
            //     ...(IFT_OP4OEData.templateA.itGatewayOne && { itGatewayOne: IFT_OP4OEData.templateA.itGatewayOne }),
            //     ...(IFT_OP4OEData.templateA.itSubnetOne && { itSubnetOne: IFT_OP4OEData.templateA.itSubnetOne }),
            //     ...(IFT_OP4OEData.templateA.itDNSOne && { itDNSOne: IFT_OP4OEData.templateA.itDNSOne }),
            //     ...(IFT_OP4OEData.templateA.itSMTPOne && { itSMTPOne: IFT_OP4OEData.templateA.itSMTPOne }),
            //     ...(IFT_OP4OEData.templateA.itNameTwo && { itNameTwo: IFT_OP4OEData.templateA.itNameTwo }),
            //     ...(IFT_OP4OEData.templateA.itIPTwo && { itIPTwo: IFT_OP4OEData.templateA.itIPTwo }),
            //     ...(IFT_OP4OEData.templateA.itGatewayTwo && { itGatewayTwo: IFT_OP4OEData.templateA.itGatewayTwo }),
            //     ...(IFT_OP4OEData.templateA.itSubnetTwo && { itSubnetTwo: IFT_OP4OEData.templateA.itSubnetTwo }),
            //     ...(IFT_OP4OEData.templateA.itDNSTwo && { itDNSTwo: IFT_OP4OEData.templateA.itDNSTwo }),
            //     ...(IFT_OP4OEData.templateA.itSMTPTwo && { itSMTPTwo: IFT_OP4OEData.templateA.itSMTPTwo }),
            //     ...(IFT_OP4OEData.templateA.itNameThree && { itNameThree: IFT_OP4OEData.templateA.itNameThree }),
            //     ...(IFT_OP4OEData.templateA.itIPThree && { itIPThree: IFT_OP4OEData.templateA.itIPThree }),
            //     ...(IFT_OP4OEData.templateA.itGatewayThree && { itGatewayThree: IFT_OP4OEData.templateA.itGatewayThree }),
            //     ...(IFT_OP4OEData.templateA.itSubnetThree && { itSubnetThree: IFT_OP4OEData.templateA.itSubnetThree }),
            //     ...(IFT_OP4OEData.templateA.itDNSThree && { itDNSThree: IFT_OP4OEData.templateA.itDNSThree }),
            //     ...(IFT_OP4OEData.templateA.itSMTPThree && { itSMTPThree: IFT_OP4OEData.templateA.itSMTPThree }),
            //     ...(IFT_OP4OEData.templateA.itAdditionalNotes && { itAdditionalNotes: IFT_OP4OEData.templateA.itAdditionalNotes }),
