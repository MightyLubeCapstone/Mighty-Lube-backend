...
router.post("/", authenticate, async (req, res) => {
  try {
    ...
    const order = new PAF_GPC({
      ...
      compressedAir: PAF_GPCData.compressedAir,
      ...(PAF_GPCData.airSupplyType && { airSupplyType: PAF_GPCData.airSupplyType }),
      ...
      ...(PAF_GPCData.plcConnection && { plcConnection: PAF_GPCData.plcConnection }),
      ...(PAF_GPCData.otherControllerNotes && { otherControllerNotes: PAF_GPCData.otherControllerNotes }),

      gpcUnitType: PAF_GPCData.gpcUnitType,
      chainDrop: PAF_GPCData.chainDrop,

      ...(PAF_GPCData.gpcDiameter && { gpcDiameter: PAF_GPCData.gpcDiameter }),
      ...(PAF_GPCData.gpcWheelC && { gpcWheelC: PAF_GPCData.gpcWheelC }),
      ...(PAF_GPCData.gpcWheelD && { gpcWheelD: PAF_GPCData.gpcWheelD }),
      ...(PAF_GPCData.gpcWheelE && { gpcWheelE: PAF_GPCData.gpcWheelE }),
      ...(PAF_GPCData.gpcWheelF && { gpcWheelF: PAF_GPCData.gpcWheelF }),
      ...(PAF_GPCData.gpcWheelG && { gpcWheelG: PAF_GPCData.gpcWheelG }),
      ...(PAF_GPCData.gpcWheelH && { gpcWheelH: PAF_GPCData.gpcWheelH }),
      ...(PAF_GPCData.gpcWheelS && { gpcWheelS: PAF_GPCData.gpcWheelS }),

      // ✅ optional
      ...(PAF_GPCData.technicianNote && { technicianNote: PAF_GPCData.technicianNote }),
    });
