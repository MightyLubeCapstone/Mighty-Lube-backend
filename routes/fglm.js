...
router.post("/", authenticate, async (req, res) => {
    ...
    try {
        ...
        const order = new FGLM({
            ...
            // This field is used to store additional notes/comments added by technician
            // Optional field – will be saved only if value is provided
            ...(fglmData.technicianNote && { technicianNote: fglmData.technicianNote }),
