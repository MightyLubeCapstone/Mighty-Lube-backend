...
const { authenticate } = require("./sessions");
const OHP_OP4A = require("../models/OHP_OP4A");
const templateA = require("../models/templateA"); // kept (even if unused)
...
router.post("/", authenticate, async (req, res) => {
  try {
    ...
    const order = new OHP_OP4A({
      ...
      wheelManufacturer: OHP_OP4AData.wheelManufacturer,
      ...(OHP_OP4AData.otherWheelManufacturer && {
        otherWheelManufacturer: OHP_OP4AData.otherWheelManufacturer,
      }),
      ...
      ...(OHP_OP4AData.ovenStatus && { ovenStatus: OHP_OP4AData.ovenStatus }),
      ...(OHP_OP4AData.ovenTemp && { ovenTemp: OHP_OP4AData.ovenTemp }),
      ...(OHP_OP4AData.otherAppEnviroment && {
        otherAppEnviroment: OHP_OP4AData.otherAppEnviroment,
      }),
      ...
      monitorData: {
        ...
        ...(OHP_OP4AData.templateA.existingWindows && {
          existingWindows: OHP_OP4AData.templateA.existingWindows,
        }),
        ...(OHP_OP4AData.templateA.existingHeadUnit && {
          existingHeadUnit: OHP_OP4AData.templateA.existingHeadUnit,
        }),
        ...(OHP_OP4AData.templateA.existingDCU && { existingDCU: OHP_OP4AData.templateA.existingDCU }),
        ...(OHP_OP4AData.templateA.existingPowerInterface && {
          existingPowerInterface: OHP_OP4AData.templateA.existingPowerInterface,
        }),

        ...(OHP_OP4AData.templateA.newReservoir && { newReservoir: OHP_OP4AData.templateA.newReservoir }),
        ...(OHP_OP4AData.templateA.reservoirSize && { reservoirSize: OHP_OP4AData.templateA.reservoirSize }),
        ...(OHP_OP4AData.templateA.otherReservoirSize && {
          otherReservoirSize: OHP_OP4AData.templateA.otherReservoirSize,
        }),
        ...(OHP_OP4AData.templateA.newReservoirNum && {
          newReservoirNum: OHP_OP4AData.templateA.newReservoirNum,
        }),

        ...(OHP_OP4AData.templateA.typeMonitor && { typeMonitor: OHP_OP4AData.templateA.typeMonitor }),

        ...(OHP_OP4AData.templateA.driveMotorAmp && { driveMotorAmp: OHP_OP4AData.templateA.driveMotorAmp }),
        ...(OHP_OP4AData.templateA.driveMotorAmpNum && {
          driveMotorAmpNum: OHP_OP4AData.templateA.driveMotorAmpNum,
        }),

        ...(OHP_OP4AData.templateA.driveTakeUpAir && {
          driveTakeUpAir: OHP_OP4AData.templateA.driveTakeUpAir,
        }),
        ...(OHP_OP4AData.templateA.driveTakeUpAirNum && {
          driveTakeUpAirNum: OHP_OP4AData.templateA.driveTakeUpAirNum,
        }),

        ...(OHP_OP4AData.templateA.takeUpDistance && { takeUpDistance: OHP_OP4AData.templateA.takeUpDistance }),
        ...(OHP_OP4AData.templateA.takeUpDistanceNum && {
          takeUpDistanceNum: OHP_OP4AData.templateA.takeUpDistanceNum,
        }),
        ...
        ...(OHP_OP4AData.templateA.driveVibration && { driveVibration: OHP_OP4AData.templateA.driveVibration }),
        ...(OHP_OP4AData.templateA.driveVibrationNum && {
          driveVibrationNum: OHP_OP4AData.templateA.driveVibrationNum,
        }),
        ...
        ...(OHP_OP4AData.templateA.paintMarker && { paintMarker: OHP_OP4AData.templateA.paintMarker }),
        ...(OHP_OP4AData.templateA.paintMarkerNum && {
          paintMarkerNum: OHP_OP4AData.templateA.paintMarkerNum,
        }),
        ...
        ...(OHP_OP4AData.templateA.switchDistance && { switchDistance: OHP_OP4AData.templateA.switchDistance }),
        ...(OHP_OP4AData.templateA.ampPickup && { ampPickup: OHP_OP4AData.templateA.ampPickup }),
        ...(OHP_OP4AData.templateA.fromAirTakeUpDistance && {
          fromAirTakeUpDistance: OHP_OP4AData.templateA.fromAirTakeUpDistance,
        }),

        ...(OHP_OP4AData.templateA.specialControllerOptions && {
          specialControllerOptions: OHP_OP4AData.templateA.specialControllerOptions,
        }),

        ...(OHP_OP4AData.templateA.operatingVoltage && {
          operatingVoltage: OHP_OP4AData.templateA.operatingVoltage,
        }),
      },
