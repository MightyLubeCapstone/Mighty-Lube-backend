...
router.post("/", authenticate, async (req, res) => {
    // Used for creating and saving FRO_317 form data into user's cart
    try {
        const { FRO_317Data, numRequested } = req.body;
        ...
        const order = new FRO_317({
            ...
            // technicianNote:
            // This field is used to store additional remarks or observations
            // added by the technician during form filling or site inspection.
            // It is optional and does not affect existing form logic.
            ...(FRO_317Data.technicianNote && { technicianNote: FRO_317Data.technicianNote }),
