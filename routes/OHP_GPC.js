...
//             ...(OHP_GPCData.otherAppEnviroment && { otherAppEnviroment: OHP_GPCData.otherAppEnviroment }),
...
//             ...(OHP_GPCData.plantLayout && { plantLayout: OHP_GPCData.plantLayout }),
//             operatingVoltSingle: OHP_GPCData.operatingVoltSingle,
//             controlVoltSingle: OHP_GPCData.controlVoltSingle,
//             compressedAir: OHP_GPCData.compressedAir,
//         monitorData: 
//         {
...
//             ...(OHP_GPCData.electricStatus && { electricStatus: OHP_GPCData.electricStatus }),
...
//             ...(OHP_GPCData.otherPreMountType && { otherPreMountType: OHP_GPCData.otherPreMountType }),
//             ...(OHP_GPCData.plcConnection && { plcConnection: OHP_GPCData.plcConnection }),
  ...
  try {
    ...
    const order = new OHP_GPC({
      ...
      monitorData: {
        ...
        ...(OHP_GPCData?.templateA?.existingHeadUnit && { existingHeadUnit: OHP_GPCData.templateA.existingHeadUnit }),
        ...(OHP_GPCData?.templateA?.existingDCU && { existingDCU: OHP_GPCData.templateA.existingDCU }),
        ...(OHP_GPCData?.templateA?.existingPowerInterface && {
          existingPowerInterface: OHP_GPCData.templateA.existingPowerInterface,
        }),
        ...(OHP_GPCData?.templateA?.newReservoir && { newReservoir: OHP_GPCData.templateA.newReservoir }),
        ...(OHP_GPCData?.templateA?.reservoirSize && { reservoirSize: OHP_GPCData.templateA.reservoirSize }),
        ...(OHP_GPCData?.templateA?.otherReservoirSize && {
          otherReservoirSize: OHP_GPCData.templateA.otherReservoirSize,
        }),
        ...(OHP_GPCData?.templateA?.newReservoirNum && { newReservoirNum: OHP_GPCData.templateA.newReservoirNum }),
        ...(OHP_GPCData?.templateA?.typeMonitor && { typeMonitor: OHP_GPCData.templateA.typeMonitor }),
        ...
        ...(OHP_GPCData?.templateA?.driveMotorAmpNum && { driveMotorAmpNum: OHP_GPCData.templateA.driveMotorAmpNum }),
        ...(OHP_GPCData?.templateA?.driveTakeUpAir && { driveTakeUpAir: OHP_GPCData.templateA.driveTakeUpAir }),
        ...(OHP_GPCData?.templateA?.driveTakeUpAirNum && {
          driveTakeUpAirNum: OHP_GPCData.templateA.driveTakeUpAirNum,
        }),
        ...(OHP_GPCData?.templateA?.takeUpDistance && { takeUpDistance: OHP_GPCData.templateA.takeUpDistance }),
        ...(OHP_GPCData?.templateA?.takeUpDistanceNum && {
          takeUpDistanceNum: OHP_GPCData.templateA.takeUpDistanceNum,
        }),
        ...(OHP_GPCData?.templateA?.driveTemp && { driveTemp: OHP_GPCData.templateA.driveTemp }),
        ...(OHP_GPCData?.templateA?.driveTempNum && { driveTempNum: OHP_GPCData.templateA.driveTempNum }),
        ...(OHP_GPCData?.templateA?.driveVibration && { driveVibration: OHP_GPCData.templateA.driveVibration }),
        ...(OHP_GPCData?.templateA?.driveVibrationNum && {
          driveVibrationNum: OHP_GPCData.templateA.driveVibrationNum,
        }),
        ...
        ...(OHP_GPCData?.templateA?.switchDistance && { switchDistance: OHP_GPCData.templateA.switchDistance }),
        ...(OHP_GPCData?.templateA?.ampPickup && { ampPickup: OHP_GPCData.templateA.ampPickup }),
        ...(OHP_GPCData?.templateA?.fromAirTakeUpDistance && {
          fromAirTakeUpDistance: OHP_GPCData.templateA.fromAirTakeUpDistance,
        }),
        ...(OHP_GPCData?.templateA?.specialControllerOptions && {
          specialControllerOptions: OHP_GPCData.templateA.specialControllerOptions,
        }),
        ...(OHP_GPCData?.templateA?.operatingVoltage && { operatingVoltage: OHP_GPCData.templateA.operatingVoltage }),
      },
      ...
      // Added: optional technician note (same pattern as your other routes)
      ...(OHP_GPCData.technicianNote && { technicianNote: OHP_GPCData.technicianNote }),
    });
