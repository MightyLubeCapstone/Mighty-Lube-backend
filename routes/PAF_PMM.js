...
router.post("/", authenticate, async (req, res) => {
    try {
        ...
        const order = new PAF_PMM({
            conveyorName: PAF_PMMData.conveyorName,
            chainSize: PAF_PMMData.chainSize,
            ...(PAF_PMMData.otherChainSize && { 
                otherChainSize: PAF_PMMData.otherChainSize 
            }),
            orientationType: PAF_PMMData.orientationType,

            // ✅ NEW FIELD ADDED
            // Used for technician-specific remarks / observations
            technicianNote: PAF_PMMData.technicianNote
        });
