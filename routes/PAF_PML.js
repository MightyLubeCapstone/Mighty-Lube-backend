...
router.post("/", authenticate, async (req, res) => {
    try {
        ...
        const order = new PAF_PML({
            ...
            industrialChainManufacturer: PAF_PMLData.industrialChainManufacturer,
            ...(PAF_PMLData.otherChainManufacturer && {
                otherChainManufacturer: PAF_PMLData.otherChainManufacturer
            }),
            ...
            // ✅ NEW FIELD ADDED
            // Technician can add any additional notes or observations here
            technicianNote: PAF_PMLData.technicianNote
        });
