...
router.post("/", authenticate, async (req, res) => {
  try {
    ...
    const order = new PAF_MLP({
      ...
      catDriveStatus: PAF_MLPData.catDriveStatus,
      ...(PAF_MLPData.catDriveNum && { catDriveNum: PAF_MLPData.catDriveNum }),
      ...
      // ✅ optional (add only if schema has these)
      ...(PAF_MLPData.plcConnection && { plcConnection: PAF_MLPData.plcConnection }),
      ...(PAF_MLPData.otherControllerNotes && { otherControllerNotes: PAF_MLPData.otherControllerNotes }),
      ...(PAF_MLPData.technicianNote && { technicianNote: PAF_MLPData.technicianNote }),
    });
