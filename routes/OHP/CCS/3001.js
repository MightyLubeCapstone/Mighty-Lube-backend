...
const OHP_001 = require("../../../models/OHP/CCS/3001");
...
router.post("/", authenticate, async (req, res) => {
  try {
    ...
    return res.status(201).json({
      ...
      message:
        "OHP_001 configuration added to cart successfully",
    ...
    return res.status(500).json({
      ...
      message:
        "Failed to add OHP_001 configuration",
    });
  }
});
