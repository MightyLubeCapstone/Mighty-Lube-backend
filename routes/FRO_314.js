...
router.post("/", authenticate, async (req, res) => {
    // Used for FRO_314 form submission
    try {
        const { FRO_314Data, numRequested } = req.body;
        ...
        const order = new FRO_314({
            ...
            // Application environment (Prod / QA / etc.)
            appEnviroment: FRO_314Data.appEnviroment,
            ...
            // -----------------------------
            // NEW FIELD ADDED
            // Technician can add any additional notes / observations here
            // This is optional and saved only if provided
            ...(FRO_314Data.technicianNote && { technicianNote: FRO_314Data.technicianNote }),
            // -----------------------------
        ...
        // Push product configuration into user's cart
        req.user.cart.push({
