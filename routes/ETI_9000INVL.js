...
//                 ...(ETI_9000INVLData.templateB.chainMaster && { chainMaster: ETI_9000INVLData.templateB.chainMaster}),
//                 ...(ETI_9000INVLData.templateB.remoteStatus && { remoteStatus: ETI_9000INVLData.templateB.remoteStatus}),
//                 ...(ETI_9000INVLData.templateB.mountStatus && { mountStatus: ETI_9000INVLData.templateB.mountStatus}),
//                 ...(ETI_9000INVLData.templateB.otherUnitStatus && { otherUnitStatus: ETI_9000INVLData.templateB.otherUnitStatus}),
//                 ...(ETI_9000INVLData.templateB.timerStatus && { timerStatus: ETI_9000INVLData.templateB.timerStatus}),
//                 ...(ETI_9000INVLData.templateB.electricStatus && { electricStatus: ETI_9000INVLData.templateB.electricStatus}),
//                 ...(ETI_9000INVLData.templateB.mightyLubeMonitoring && { mightyLubeMonitoring: ETI_9000INVLData.templateB.mightyLubeMonitoring}),
//                 ...(ETI_9000INVLData.templateB.preMountType && { preMountType: ETI_9000INVLData.templateB.preMountType}),
//                 ...(ETI_9000INVLData.templateB.otherPreMountType && { otherPreMountType: ETI_9000INVLData.templateB.otherPreMountType}),
//                 ...(ETI_9000INVLData.templateB.plcConnection && { plcConnection: ETI_9000INVLData.templateB.plcConnection}),
//                 ...(ETI_9000INVLData.templateB.otherControllerNotes && { otherControllerNotes: ETI_9000INVLData.templateB.otherControllerNotes}),
//                 ...(ETI_9000INVLData.templateB.templateB_UnitType && { templateB_UnitType: ETI_9000INVLData.templateB.templateB_UnitType}),
//                 ...(ETI_9000INVLData.templateB.templateB_InvertedB && { templateB_InvertedB: ETI_9000INVLData.templateB.templateB_InvertedB}),
//                 ...(ETI_9000INVLData.templateB.templateB_InvertedE && { templateB_InvertedE: ETI_9000INVLData.templateB.templateB_InvertedE}),
//                 ...(ETI_9000INVLData.templateB.templateB_InvertedG && { templateB_InvertedG: ETI_9000INVLData.templateB.templateB_InvertedG}),
//                 ...(ETI_9000INVLData.templateB.templateB_InvertedH && { templateB_InvertedH: ETI_9000INVLData.templateB.templateB_InvertedH}),
//                 ...(ETI_9000INVLData.templateB.templateB_InvertedK && { templateB_InvertedK: ETI_9000INVLData.templateB.templateB_InvertedK}),
//                 ...(ETI_9000INVLData.templateB.templateB_InvertedT && { templateB_InvertedT: ETI_9000INVLData.templateB.templateB_InvertedT}),
//                 ...(ETI_9000INVLData.templateB.templateB_InvertedU && { templateB_InvertedU: ETI_9000INVLData.templateB.templateB_InvertedU}),
//                 ...(ETI_9000INVLData.templateB.templateB_InvertedV && { templateB_InvertedV: ETI_9000INVLData.templateB.templateB_InvertedV}),
//                 ...(ETI_9000INVLData.templateB.templateB_InvertedW && { templateB_InvertedW: ETI_9000INVLData.templateB.templateB_InvertedW}),
...
/**
 * routes/ETI_9000INVL.js
 * ---------------------
 * ✅ What this route does:
 * - Takes ETI_9000INVL form payload from frontend
 * - Builds a Mongoose ETI_9000INVL configuration document (order)
 * - Pushes that configuration into authenticated user's cart
 * - Adds technicianNote (NEW) safely
 *
 * IMPORTANT:
 * 1) Make sure your ETI_9000INVL mongoose schema contains:
 *    technicianNote: { type: String, required: false }
 * 2) templateA/templateB/templateC/templateE imports are not used directly here.
 *    You can safely remove those require() lines (optional cleanup).
 */

const express = require("express");
const { dbConnect } = require("../config/config"); // not used directly here
const { authenticate } = require("./sessions");
const ETI_9000INVL = require("../models/ETI_9000INVL");
...
router.post("/", authenticate, async (req, res) => {
  try {
    ...
    // ✅ Avoid crashes if frontend forgets ETI_9000INVLData
    if (!ETI_9000INVLData) {
      return res.status(400).json({ error: "ETI_9000INVLData is required" });
    }
    ...
    const order = new ETI_9000INVL({
      ...
      ...(ETI_9000INVLData.conveyorLength && {
        conveyorLength: ETI_9000INVLData.conveyorLength,
      }),
      ...(ETI_9000INVLData.conveyorLengthUnit && {
        conveyorLengthUnit: ETI_9000INVLData.conveyorLengthUnit,
      }),
      ...
      ...(ETI_9000INVLData.travelDirection && {
        travelDirection: ETI_9000INVLData.travelDirection,
      }),
      ...
      ...(ETI_9000INVLData.otherAppEnviroment && {
        otherAppEnviroment: ETI_9000INVLData.otherAppEnviroment,
      }),
      ...(ETI_9000INVLData.surroundingTemp && {
        surroundingTemp: ETI_9000INVLData.surroundingTemp,
      }),
      ...(ETI_9000INVLData.conveyorLoaded && {
        conveyorLoaded: ETI_9000INVLData.conveyorLoaded,
      }),
      ...
      // NOTE: Your original templateBData/templateCData/templateEData blocks are huge.
      // I am keeping your structure intact and only adding technicianNote below
      templateBData: ETI_9000INVLData.templateB,
      templateCData: ETI_9000INVLData.templateC,
      templateEData: ETI_9000INVLData.templateE,
       ...
       * - Trimmed so empty spaces don't get stored
       */
      ...(ETI_9000INVLData.technicianNote &&
        ETI_9000INVLData.technicianNote.trim() && {
          technicianNote: ETI_9000INVLData.technicianNote.trim(),
        }),
    });
