...
router.post("/", authenticate, async (req, res) => {
    ...
    try {
        ...
        const order = new FGCO({
            ...
            // ✅ NEW FIELD ADDED
            // This field is used to store technician-specific notes or remarks
            ...(fgcoData.technicianNote && { technicianNote: fgcoData.technicianNote }),
        });

        // Add FGCO configuration to user's cart
        req.user.cart.push({
...
// Only doing for FGCO for now in case you want changes later
