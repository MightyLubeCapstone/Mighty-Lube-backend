...
router.post("/", authenticate, async (req, res) => {
    ...
    try {
        ...
        const order = new IBR_OP4OE({
            ...
            //     ...(IBR_OP4OEData.templateA.itNameOne && { itNameOne: IBR_OP4OEData.templateA.itNameOne }),
            //     ...(IBR_OP4OEData.templateA.itIPOne && { itIPOne: IBR_OP4OEData.templateA.itIPOne }),
            //     ...(IBR_OP4OEData.templateA.itGatewayOne && { itGatewayOne: IBR_OP4OEData.templateA.itGatewayOne }),
            //     ...(IBR_OP4OEData.templateA.itSubnetOne && { itSubnetOne: IBR_OP4OEData.templateA.itSubnetOne }),
            //     ...(IBR_OP4OEData.templateA.itDNSOne && { itDNSOne: IBR_OP4OEData.templateA.itDNSOne }),
            //     ...(IBR_OP4OEData.templateA.itSMTPOne && { itSMTPOne: IBR_OP4OEData.templateA.itSMTPOne }),
            //     ...(IBR_OP4OEData.templateA.itNameTwo && { itNameTwo: IBR_OP4OEData.templateA.itNameTwo }),
            //     ...(IBR_OP4OEData.templateA.itIPTwo && { itIPTwo: IBR_OP4OEData.templateA.itIPTwo }),
            //     ...(IBR_OP4OEData.templateA.itGatewayTwo && { itGatewayTwo: IBR_OP4OEData.templateA.itGatewayTwo }),
            //     ...(IBR_OP4OEData.templateA.itSubnetTwo && { itSubnetTwo: IBR_OP4OEData.templateA.itSubnetTwo }),
            //     ...(IBR_OP4OEData.templateA.itDNSTwo && { itDNSTwo: IBR_OP4OEData.templateA.itDNSTwo }),
            //     ...(IBR_OP4OEData.templateA.itSMTPTwo && { itSMTPTwo: IBR_OP4OEData.templateA.itSMTPTwo }),
            //     ...(IBR_OP4OEData.templateA.itNameThree && { itNameThree: IBR_OP4OEData.templateA.itNameThree }),
            //     ...(IBR_OP4OEData.templateA.itIPThree && { itIPThree: IBR_OP4OEData.templateA.itIPThree }),
            //     ...(IBR_OP4OEData.templateA.itGatewayThree && { itGatewayThree: IBR_OP4OEData.templateA.itGatewayThree }),
            //     ...(IBR_OP4OEData.templateA.itSubnetThree && { itSubnetThree: IBR_OP4OEData.templateA.itSubnetThree }),
            //     ...(IBR_OP4OEData.templateA.itDNSThree && { itDNSThree: IBR_OP4OEData.templateA.itDNSThree }),
            //     ...(IBR_OP4OEData.templateA.itSMTPThree && { itSMTPThree: IBR_OP4OEData.templateA.itSMTPThree }),
            //     ...(IBR_OP4OEData.templateA.itAdditionalNotes && { itAdditionalNotes: IBR_OP4OEData.templateA.itAdditionalNotes }),
