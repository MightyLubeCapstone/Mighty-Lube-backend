 ...
 * routes/FC_317.js
 * ----------------
 * ✅ Adds FC_317 configuration into authenticated user's cart
 * ✅ NEW: technicianNote (optional)
 * ✅ Safer: uses optional chaining so missing templateA/templateC won't crash the API
 *
 * NOTE:
 * 1) Add `technicianNote` in FC_317 mongoose schema:
...
router.post("/", authenticate, async (req, res) => {
  try {
    ...
    if (!FC_317Data) {
      return res.status(400).json({ error: "FC_317Data is required" });
    }
    ...
    const order = new FC_317({
      templateCData: {
        conveyorName: FC_317Data.templateC?.conveyorName,
        industrialChainManufacturer: FC_317Data.templateC?.industrialChainManufacturer,
        ...(FC_317Data.templateC?.otherChainManufacturer && {
          otherChainManufacturer: FC_317Data.templateC.otherChainManufacturer,
        }),
        ...
        templateA_CData: {
          ...
          ...(FC_317Data.templateA?.existingHeadUnit && { existingHeadUnit: FC_317Data.templateA.existingHeadUnit }),
          ...(FC_317Data.templateA?.existingDCU && { existingDCU: FC_317Data.templateA.existingDCU }),
          ...(FC_317Data.templateA?.existingPowerInterface && {
            existingPowerInterface: FC_317Data.templateA.existingPowerInterface,
          }),
          ...(FC_317Data.templateA?.newReservoir && { newReservoir: FC_317Data.templateA.newReservoir }),
          ...(FC_317Data.templateA?.reservoirSize && { reservoirSize: FC_317Data.templateA.reservoirSize }),
          ...(FC_317Data.templateA?.otherReservoirSize && { otherReservoirSize: FC_317Data.templateA.otherReservoirSize }),
          ...
          ...(FC_317Data.templateA?.switchDistance && { switchDistance: FC_317Data.templateA.switchDistance }),
          ...(FC_317Data.templateA?.ampPickup && { ampPickup: FC_317Data.templateA.ampPickup }),
          ...(FC_317Data.templateA?.fromAirTakeUpDistance && {
            fromAirTakeUpDistance: FC_317Data.templateA.fromAirTakeUpDistance,
          }),
          ...(FC_317Data.templateA?.specialControllerOptions && {
            specialControllerOptions: FC_317Data.templateA.specialControllerOptions,
          }),
          ...(FC_317Data.templateA?.operatingVoltage && { operatingVoltage: FC_317Data.templateA.operatingVoltage }),
        },
        ...
        // ✅ FIX: your original code was mistakenly setting `lubeType:` for many unrelated fields.
        ...(FC_317Data.templateC?.chainMaster && { chainMaster: FC_317Data.templateC.chainMaster }),
        ...(FC_317Data.templateC?.remoteStatus && { remoteStatus: FC_317Data.templateC.remoteStatus }),
        ...(FC_317Data.templateC?.mountStatus && { mountStatus: FC_317Data.templateC.mountStatus }),
        ...(FC_317Data.templateC?.otherUnitStatus && { otherUnitStatus: FC_317Data.templateC.otherUnitStatus }),
        ...(FC_317Data.templateC?.timerStatus && { timerStatus: FC_317Data.templateC.timerStatus }),
        ...(FC_317Data.templateC?.electricStatus && { electricStatus: FC_317Data.templateC.electricStatus }),
        ...(FC_317Data.templateC?.mightyLubeMonitoring && { mightyLubeMonitoring: FC_317Data.templateC.mightyLubeMonitoring }),
        ...(FC_317Data.templateC?.preMountType && { preMountType: FC_317Data.templateC.preMountType }),
        ...(FC_317Data.templateC?.otherPreMountType && { otherPreMountType: FC_317Data.templateC.otherPreMountType }),
        ...(FC_317Data.templateC?.plcConnection && { plcConnection: FC_317Data.templateC.plcConnection }),
        ...(FC_317Data.templateC?.otherControllerNotes && { otherControllerNotes: FC_317Data.templateC.otherControllerNotes }),
        ...(FC_317Data.templateC?.templateC_UnitType && { templateC_UnitType: FC_317Data.templateC.templateC_UnitType }),
      ...
      // ✅ NEW FIELD (top-level)
      ...(FC_317Data.technicianNote && FC_317Data.technicianNote.trim() && {
        technicianNote: FC_317Data.technicianNote.trim(),
      }),
    });
