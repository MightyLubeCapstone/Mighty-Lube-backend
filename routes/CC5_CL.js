...
router.post("/", authenticate, async (req, res) => {
    ...
    try {
        ...
        const order = new CC5_CL({
            ...
            ...(CC5_CLData.conveyorLengthUnit && { conveyorLengthUnit: CC5_CLData.conveyorLengthUnit }),
            conveyorSpeed: CC5_CLData.conveyorSpeed,
            ...(CC5_CLData.conveyorSpeedUnit && { conveyorSpeedUnit: CC5_CLData.conveyorSpeedUnit }),
        ...
        monitorData: 
        {
                existingMonitor: CC5_CLData.templateA.existingMonitor,
                newMonitor: CC5_CLData.templateA.newMonitor,		
