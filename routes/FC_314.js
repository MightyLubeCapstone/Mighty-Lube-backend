 ...
 * routes/FC_314.js
 * ----------------
 * ✅ Adds FC_314 configuration into authenticated user's cart
 * ✅ NEW: technicianNote (optional)
 * ✅ Safer: uses optional chaining so missing templateA/templateB won't crash the API
 *
 * NOTE:
 * 1) Add `technicianNote` in FC_314 mongoose schema:
...
router.post("/", authenticate, async (req, res) => {
  try {
    ...
    if (!FC_314Data) {
      return res.status(400).json({ error: "FC_314Data is required" });
    }
    ...
    const order = new FC_314({
      templateBData: {
        conveyorName: FC_314Data.templateB?.conveyorName,
        industrialChainManufacturer: FC_314Data.templateB?.industrialChainManufacturer,
        ...(FC_314Data.templateB?.otherChainManufacturer && {
          otherChainManufacturer: FC_314Data.templateB.otherChainManufacturer,
        }),
        ...
        templateA_BData: {
          ...
          ...(FC_314Data.templateA?.existingHeadUnit && { existingHeadUnit: FC_314Data.templateA.existingHeadUnit }),
          ...(FC_314Data.templateA?.existingDCU && { existingDCU: FC_314Data.templateA.existingDCU }),
          ...(FC_314Data.templateA?.existingPowerInterface && {
            existingPowerInterface: FC_314Data.templateA.existingPowerInterface,
          }),
          ...(FC_314Data.templateA?.newReservoir && { newReservoir: FC_314Data.templateA.newReservoir }),
          ...(FC_314Data.templateA?.reservoirSize && { reservoirSize: FC_314Data.templateA.reservoirSize }),
          ...(FC_314Data.templateA?.otherReservoirSize && { otherReservoirSize: FC_314Data.templateA.otherReservoirSize }),
          ...
          ...(FC_314Data.templateA?.switchDistance && { switchDistance: FC_314Data.templateA.switchDistance }),
          ...(FC_314Data.templateA?.ampPickup && { ampPickup: FC_314Data.templateA.ampPickup }),
          ...(FC_314Data.templateA?.fromAirTakeUpDistance && {
            fromAirTakeUpDistance: FC_314Data.templateA.fromAirTakeUpDistance,
          }),
          ...(FC_314Data.templateA?.specialControllerOptions && {
            specialControllerOptions: FC_314Data.templateA.specialControllerOptions,
          }),
          ...(FC_314Data.templateA?.operatingVoltage && { operatingVoltage: FC_314Data.templateA.operatingVoltage }),
        },
      ...
      // ✅ NEW FIELD (top-level)
      ...(FC_314Data.technicianNote && FC_314Data.technicianNote.trim() && {
        technicianNote: FC_314Data.technicianNote.trim(),
      }),
    });
