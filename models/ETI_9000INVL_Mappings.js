const enumMappingsETI_9000INVL = {

    industrialChainManufacturer: { 1: "Webb", 2: "Richard-Wilcox", 3: "Rapid", 4: "Pacline", 5: "Other"},
    ...
    templateEData: {
        ...
        chainSize: { 1: "X348 Chain (3\")", 2: "X458 Chain (4\")", 3: "X678 Chain (6\")", 4: "Other", },
    ...
    ctrStatus: { 1: "Yes", 2: "No" },

    plcConnection: { 1: "Yes", 2: "No" },

    monitorControlStatus: { 1: "Yes", 2: "No" },
...
module.exports = enumMappingsETI_9000INVL;
