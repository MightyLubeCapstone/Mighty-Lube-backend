const enumMappingsIDT_IFTL = {

  pitchBetweenRollers: { 1: "X348 Chain (3\")", 2: "X458 Chain (4\")", 3: "X678 Chain (6\")", 4: "3/8\" Log Chain", 5: "Other" },
  ...
  requiredPics: { 1: "Yes", 2: "No" },
    ...
    brushingsStatus: { 1: "Yes", 2: "No" },

    riderPlatesStatus: { 1: "Yes", 2: "No" },
    ...
    washdownStatus: { 1: "Yes", 2: "No" },

    iftUnitType: { 1: "Feet", 2: "Inches", 3: "Meters", 4: "Millimeters" },

};

module.exports = enumMappingsIDT_IFTL;
